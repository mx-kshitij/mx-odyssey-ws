...
const CURRENT_VIEW_COUNT = gql`
  query Query($numberOfViewsId: ID!) {
    numberOfViews(id: $numberOfViewsId)
  }
`;
...
const TrackCard = ({ track }) => {
  ...
  //   pubsub.publish("NUMBER_INCREMENTED", { numberIncremented: data.incrementTrackViews.track})
  // };
